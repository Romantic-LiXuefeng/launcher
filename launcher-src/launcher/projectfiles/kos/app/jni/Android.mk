...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/external \
	...
	$(LOCAL_PATH)/librose \
	$(LOCAL_PATH)/launcher \
	$(LOCAL_PATH)/launcher/../external/freerdp/channels/rdpgfx/server/.. \
	$(LOCAL_PATH)/launcher/../external/freerdp/channels/rdpsnd/common \
	$(LOCAL_PATH)/launcher/../external/freerdp/include \
	$(LOCAL_PATH)/launcher/../external/freerdp/out \
	$(LOCAL_PATH)/launcher/../external/freerdp/out/include \
	$(LOCAL_PATH)/launcher/../external/freerdp/out/winpr/include \
	$(LOCAL_PATH)/launcher/../external/freerdp/server/shadow/. \
	$(LOCAL_PATH)/launcher/../external/freerdp/winpr/include \
	$(LOCAL_PATH)/launcher/../external/freerdp/winpr/libwinpr/utils/. \
	$(LOCAL_PATH)/launcher/../external/freerdp/winpr/libwinpr/utils/trio
...
LOCAL_LDLIBS := -lkosapi -lz -llog -lOpenSLES -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf -lvpx -lprotobuf -lopencv -lkosapi
