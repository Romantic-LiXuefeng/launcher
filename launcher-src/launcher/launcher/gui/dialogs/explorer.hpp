...
class texplorer: public tdialog, public tstatusbar
{
public:
	...
	explicit texplorer(net::trdpd_manager& rdpd_mgr, const std::string& initial, const tentry& extra, bool only_extra_entry);
...
private:
	...
	{
	public:
		tauto_select_lock(texplorer& browse)
			: browse_(browse)
		{
