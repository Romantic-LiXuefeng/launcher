...
typedef void (*psTextClipboardUpdated)(CliprdrServerContext* context, const char* text);
typedef void (*psHdropCopied)(CliprdrServerContext* context, const char* c_str, int size);
typedef int (*psHdropPaste)(CliprdrServerContext* context, const char* path, void* progress, char* err_msg, int max_bytes);
typedef BOOL (*psCanHdropPaste)(CliprdrServerContext* context);
