...
void clear_file_array(wfClipboard* clipboard)
{
	size_t i;
 ...
 */
static UINT wf_cliprdr_client_capabilities(CliprdrServerContext* context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_client_format_list(CliprdrServerContext* context,
 ...
 */
static UINT
wf_cliprdr_client_format_list_response(CliprdrServerContext* context,
 ...
 */
static UINT
wf_cliprdr_client_lock_clipboard_data(CliprdrServerContext* context,
 ...
 */
static UINT
wf_cliprdr_client_unlock_clipboard_data(CliprdrServerContext* context,
...
static BOOL wf_cliprdr_traverse_directory(wfClipboard* clipboard, const wchar_t* Dir, size_t pathLen)
{
	...
	::walk_dir(utf8_dir, true, boost::bind(
				&collect_filename
 ...
 */
static UINT
wf_cliprdr_client_format_data_request(CliprdrServerContext* context,
 ...
 */
static UINT
wf_cliprdr_client_format_data_response(CliprdrServerContext* context,
 ...
 */
static UINT
wf_cliprdr_client_file_contents_request(CliprdrServerContext* context,
 ...
 */
static UINT
wf_cliprdr_client_file_contents_response(CliprdrServerContext* context,
...
void wf_cliprdr_text_clipboard_updated(CliprdrServerContext* context, const char* text)
{
	wfClipboard* clipboard;
...
std::vector<std::string> split_with_null(const char* c_str, int size)
{
...
void wf_cliprdr_hdrop_copied(CliprdrServerContext* context, const char* c_str, int size)
{
	wfClipboard* clipboard;
...
int wf_cliprdr_hdrop_paste(CliprdrServerContext* context, const char* path, void* progress, char* err_msg, int max_bytes)
{
	wfClipboard* clipboard;
...
BOOL wf_cliprdr_can_hdrop_paste(CliprdrServerContext* context)
{
	wfClipboard* clipboard;
...
int shadow_client_cliprdr_init(rdpShadowClient* client)
{
	...
	cliprdr->ClientCapabilities = wf_cliprdr_client_capabilities;
	// cliprdr->TempDirectory = pf_cliprdr_TempDirectory;
	cliprdr->ClientFormatList = wf_cliprdr_client_format_list;
	cliprdr->ClientFormatListResponse = wf_cliprdr_client_format_list_response;
	cliprdr->ClientLockClipboardData = wf_cliprdr_client_lock_clipboard_data;
	cliprdr->ClientUnlockClipboardData = wf_cliprdr_client_unlock_clipboard_data;
	cliprdr->ClientFormatDataRequest = wf_cliprdr_client_format_data_request;
	cliprdr->ClientFormatDataResponse = wf_cliprdr_client_format_data_response;
	cliprdr->ClientFileContentsRequest = wf_cliprdr_client_file_contents_request;
	cliprdr->ClientFileContentsResponse = wf_cliprdr_client_file_contents_response;
