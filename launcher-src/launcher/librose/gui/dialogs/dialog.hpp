...
public:
	...
	virtual void set_align(int align) = 0;
...
bool run_with_progress_widget(bool clear_event, const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, int hidden_ms, const SDL_Rect& rect = SDL_Rect{nposm, nposm, nposm, nposm}, const boost::function<void (ttrack&, const SDL_Rect&, int, const std::string&)>& did_draw_bar = NULL);
bool run_with_progress_dlg(const std::string& title, const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, int hidden_ms, const std::string& cancel_img, const SDL_Rect& rect = SDL_Rect{nposm, nposm, nposm, nposm}, const boost::function<void (ttrack&, const SDL_Rect&, int, const std::string&)>& did_draw_bar = NULL);
