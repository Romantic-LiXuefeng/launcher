...
{
public:
	explicit tprogress_bar(twindow& window, twidget& widget, const std::string& message, int initial_percentage, const boost::function<void (ttrack&, const SDL_Rect&, int, const std::string&)>& did_draw_bar);
	~tprogress_bar();
