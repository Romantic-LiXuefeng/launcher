...
public:
	...
	void set_did_desensitize_str(const boost::function<std::string (const ttext_box&, const std::string&)>& did)
	{
...
private:
	...
	boost::function<std::string (const ttext_box&, const std::string&)> did_desensitize_str_;
