...
bool base_instance::init_video()
{
	...
	tpre_setmode_settings pre_settings(gui2::twidget::current_landscape, silent_background_, game_config::statusbar_visible, _startup_servers, default_font_size,
...
void base_instance::check_ip_slice(bool slice)
{
	...
	if (!disable_check_ip_ && !servers_.empty() && now >= next_check_ip_ticks_) {
/*
