...
public:
	struct tpre_setmode_settings {
		tpre_setmode_settings(bool& landscape, bool& silent_background, bool& statusbar_visible, uint32_t& startup_servers, int& default_font_size, int& longpress_time, int& min_width, int& min_height)
			: landscape(landscape)
