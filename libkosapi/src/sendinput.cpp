...
NativeConnection* NativeConnection::open(const char* name, const char* uniqueId,
        int32_t screenWidth, int32_t screenHeight, int32_t maxPointers) {
    ALOGI("Registering uinput device %s: touch pad size %dx%d, "
            "max pointers %d.", name, screenWidth, screenHeight, maxPointers);
...
void NativeConnection::nativeSendPointerUp(int /*pointerId*/, int x, int y) {
    // ALOGI("NativeConnection::nativeSendPointerUp--- pointerId: %d", pointerId);
